...
//  01_UIPopoverPresentationCntroller
//
//  Created by 莫晓卉 on 2018/12/22.
//  Copyright © 2018 莫晓卉. All rights reserved.
//
import UIKit

// UIPopoverController 是在 iOS9 的时候废弃了，用 UIPopverPresentationController 来代替
// UIPopoverPresentationController 模态弹出框控制器 (UIViewController的一个属性)
